...
The first session focusses on the theoretical underpinnnings of self-employment. It highlights mechanisms related to the juxtaposition 'free choice' and 'lack of security' due to the absence of (in)formal rules regarding self-employment. We invite speakers to mostly focus on mechanisms that have been discerned in demographic, economic, geographic political or social domains. Substantively, such mechanisms might explain differences between rural and urban settings, gender differences or age in labour relations. In addition, we much welcome studies on mechanisms behind shifts in labour relations either directly, or indirectly through temporal occupation of multiple labour relations.
...
Backup, where necessary: Zijdeman & Stapel: US, long 20th century, households
