...
IF (MISSING(LABREL) & MISSING(CLASSWKD) & EMPSTATD =   0) LABREL = 10205.      /*NIU (not in universe) [In years with MISSING(CLASSWKD), this is a large part of the non-working population: therefore LABREL = 10205 instead of -1].
