...
IF (EMPSTATD = 340) LABREL = 102.       */Retiress and living on rent.
...
IF (MISSING(LABREL) & (HEADLOC ~= PERNUM) & CLASSWKRD = 123) LABREL = 42.     */Subsistence worker, own consumption [Not head of househould].
