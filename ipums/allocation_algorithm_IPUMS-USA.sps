...
IF  (YEAR = 1910 | YEAR = 1920 | YEAR = 1930) & LABREL = 14018 & ( OCC1950 = 0 |
    OCC1950 = 1 |
    OCC1950 = 2 |
    OCC1950 = 3 |
    OCC1950 = 4 |
    ...
    OCC1950 = 995 |
    OCC1950 = 997 |
    OCC1950 = 999 ) LABREL = 14.
IF  (YEAR = 1910 | YEAR = 1920 | YEAR = 1930) & LABREL = 14018 & ( OCC1950 = 9 |
    OCC1950 = 52 |
    OCC1950 = 56 |
    OCC1950 = 79 |
    OCC1950 = 93 |
    ...
    OCC1950 = 771 |
    OCC1950 = 773 |
    OCC1950 = 782 ) LABREL = 18.
EXECUTE.
*/ This reallocates the LABREL 14018 in 1910-30, using 1940 data (just like it was already used for 1850-1900).
*/ Not all occupational responses are included in the lines above, as a few OCC1950's are still LABREL '14018'.
...
*/ UPDATE 10/1/2018: reduced the number of executes in the syntax, and deleted some duplicate rules: around 15min quicker.
*/ UPDATE 15/1/2018: ca. 2-3hrs due to increase of number of lines to reorganise occupations and their labour relations 1850-1900.

*/ TEMPORARY ADDITION BELOW:
